<template>
  <div class="add">
    <div class="backButton">
      <el-page-header @back="goBack" content="Add Product"></el-page-header>
    </div>
      ...
      <div class="addForm">
        <el-form :model="product" ref="product" label-width="100px">
          ...
          <el-form-item
            ...
            <img v-if="product.images[index] !== ''" class="addImage" :src=product.images[index] alt="Description of image">
          </el-form-item>

          <el-form-item>
            <el-button type="primary" @click="submitForm('product')">Add</el-button>
